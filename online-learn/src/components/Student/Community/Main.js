...
const Main = () => {
  ...
  return (
    <div className="bg-white rounded-t-2xl mt-4 w-full flex lg:flex-row flex-col-reverse pb-12 lg:px-12 px-2 py-3 pt-4 sm:pt-0 lg:space-x-6 overflow-y-scroll h-full overflow-x-hidden">
      {isMobile && (
        <div className="absolute h-[5rem] z-10 justify-end text-black right-4 top-5">
          {isOpen ? (
